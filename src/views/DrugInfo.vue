<template>
  ...
  <div v-if="drug" class="table-container mb-4">
    <table class="table is-striped is-hoverable is-fullwidth">
      ...
      <tbody>
        ...
        <tr><th class="has-text-danger">Dose</th></tr>
        <tr>
          <td>
        ...
        <tr><th>Auth expiration date</th></tr>
        <tr>
  ...
  <div v-else-if="error" class="has-text-centered mt-5">
  ...
  <div v-else class="has-text-centered mt-g">
    Loading...
  </div>
</template>
